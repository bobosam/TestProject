namespace CRMUITests.UITests.ApplicationTests
{
    ...
    [TestClass]
    public class EditClientAddressPage : BaseTest
    {
        private string pid;
        ...
        public void ClientAddress_ValidData_Created()
        {
            ...
            this.addressPage.FillAddress(permanentAddress, 0);
            this.addressPage.AssertForIndenticalAddres();
            addressPage.DifferentAddressesRadioButtonState.Click();
            addressPage.AssertForDifferentAddres();
            this.addressPage.FillAddress(correspondationAddress, 1);
